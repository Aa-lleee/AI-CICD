...
model = Sequential([
    # Block 1 — wider entry since we have fewer features
...
history = model.fit(
    ...
    epochs=150,
    batch_size=64,
    class_weight=class_weight_dict,   # helps minority class (Truck)
    callbacks=callbacks,
    verbose=1
)
...
def predict_vehicle(age, income, gender, marital_status, occupation):
    ...
    String fields must match training values exactly.
    """
